class PerformersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @performer.save
        format.html { redirect_to performer_url(@performer), notice: "Performer was successfully created." }
  ...
  def update
    respond_to do |format|
      if @performer.update(performer_params)
        format.html { redirect_to performer_url(@performer), notice: "Performer was successfully updated." }
  ...
  private
    ...
    def performer_params
      params.require(:performer).permit(:performer_name, :performer_description, :performer_email, :performer_website, :vendor_id, :follower_user_id, :event_id, :perfomer_rank, :performers_user_id, :performer_category, :performer_subcategory, :review_id, :performer_content)
    end
end
